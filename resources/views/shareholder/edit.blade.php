...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ url('shareholders') }}">Shareholder</a></li>
            <li class="breadcrumb-item active" aria-current="page">Edit Shareholder</li>
        </ol>
    </div>
    <!-- creating  -->
    <div class="col-xl-12 col-lg-12 mb-4 pl-0">
        <div class="card">
            ...
            <div id="shareholderEdit" class="col-md-8 offset-lg-2 py-5">
                @if($message =  session('message'))
                <div class="alert alert-success">{{ $message }}</div>
            @endif
            <form id="shareholder" action="" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="form-group">
                            <iframe src="{{ asset('logos/'.$shareholder->logo) }}"  height="350" width="100%"  ></iframe>
                            <label for="pdf">Upload PDF</label>
                            <input type="file" value="{{ $shareholder->logo }}" class="form-control @error('pdf') is-invalid @enderror" name="pdf" id="pdf">
                            @error('pdf')
                                <div class="invalid-feedback"> {{ $message }}</div>
                            @enderror
                        </div>
