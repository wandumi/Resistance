...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">All Credit Rating</h1>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ url('/home') }}">Home</a></li>
            <li class="breadcrumb-item active" aria-current="page">Credit Rating</li>
        </ol>
    </div>
    <!-- Invoice Example -->
    <div class="col-xl-12 col-lg-12 mb-4 pl-0">
        <div class="card">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-primary">All Credit Rating</h6>
                <a class="m-0 float-right btn btn-primary btn-sm" href="{{ url('dmtns/credit_ratings/create') }}">Add New <i
                        class="fas fa-chevron-right"></i></a>
            </div>
            <div class="table-responsive" id="creditRatingTable">
                        ...
                        <table class="table align-items-center table-flush">
                            ...
                            @foreach($creditRatings as $creditRating)
                                <tr>
                                    ...
                                    <td>
                                        <iframe src="{{ asset('pdf_files/'.$creditRating->pdf) }}"  height="150" width="200vh" ></iframe>
                                    </td>
