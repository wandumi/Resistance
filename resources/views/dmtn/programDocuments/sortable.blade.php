...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Sort Program Documents</h1>
        <ol class="breadcrumb">
    ...
    <div class="col-xl-12 col-lg-12 mb-4 pl-0">
        <div class="card">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-primary">Sort Program Documents</h6>
            ...
            <div id="arrageBBBEE" class="col-md-12">
                  <program-sort :programdocuments="{{ $DmtnProgDocuments->toJson() }}"></program-sort>
            </div>
