...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">All Presentations</h1>
        <ol class="breadcrumb">
    ...
    <div class="col-xl-12 col-lg-12 mb-4 pl-0">
        <div class="card">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-primary">All Presentations</h6>
                        ...
                        @foreach($presentations as $presentation)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input data-id="{{ $presentation->id }}" class="toggle-class btn btn-md" type="checkbox" data-onstyle="success"
